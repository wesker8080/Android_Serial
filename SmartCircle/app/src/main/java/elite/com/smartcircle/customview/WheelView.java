package elite.com.smartcircle.customview;
...
public class WheelView extends ScrollView {
    ...
    private int selectColor = getResources().getColor(R.color.c8);
    ...
    public void setItems(List<String> list) {
        Log.d("info", "===setItems====" + list);
        if (null == items) {
            items = new ArrayList<String>();
        }
        items.clear();
        items.addAll(list);
        Log.d("info", "===items====" + items);
        // 前面和后面补全
...
//            Log.d(TAG, "向上滚动");
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (null == paint) {
            paint = new Paint();
            paint.setColor(getResources().getColor(R.color.black_20, null));
